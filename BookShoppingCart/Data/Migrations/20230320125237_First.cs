        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookName = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OredrDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OredrDetails_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OredrDetails_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OredrDetails_BookId",
                table: "OredrDetails",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_OredrDetails_OrderId",
                table: "OredrDetails",
                column: "OrderId");
        }
